...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_adv') . " (
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_carrier') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_commission_apply') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_commission_clickcount') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_commission_level') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_commission_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_commission_shop') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_designer') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_dispatch') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_feedback') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods_option') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods_param') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods_spec') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods_spec_item') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_address') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
  `realname` varchar(20) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_cart') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_favorite') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_group') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_history') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_level') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level` int(11) DEFAULT '0',
  `levelname` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_member_message_template') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_notice') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_order') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_order_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_order_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_order_refund') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_perm_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_perm_plugin') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_perm_role') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_perm_user') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_saler') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_store') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_sysset') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` text,
  `plugins` text,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_creditshop_adv') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_creditshop_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_creditshop_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_creditshop_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_virtual_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_virtual_data') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS  " . tablename('ewei_shop_virtual_type') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS  " . tablename('ewei_shop_designer_menu'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
INSERT INTO " . tablename('ewei_shop_plugin') . " (`id`, `displayorder`, `identity`, `name`, `version`, `author`, `status`) VALUES
