...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article'). " (
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article_category'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article_report'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article_share'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article_sys'). " (
  `uniacid` int(11) NOT NULL DEFAULT '0',
