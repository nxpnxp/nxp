...
class Ewei_DShop_User
{
    ...
    function getPerOpenid()
    {
        ...
        @session_start();
        $cookieid = "__cookie_ewei_shop_openid_{$_W['uniacid']}";
    ...
    function getInfo($base64 = false, $debug = false)
    {
        ...
        if (EWEI_SHOP_DEBUG) {
            $userinfo = array(
                'openid' => 'fromUser',
                'nickname' => 'fromUser',
                'headimgurl' => 'http://bbs.012wz.com/static/image/common/logo.png',
                'province' => '广东',
                'city' => '深圳'
            );
        } else {
            ...
            if (empty($userinfo['openid']) && $need_openid) {
                ...
                <html>
                    <head>
                        ...
                        <title>品质商城</title><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1, user-scalable=0'><link rel='stylesheet' type='text/css' href='https://res.wx.qq.com/connect/zh_CN/htmledition/style/wap_err1a9853.css'>
                    </head>
                    <body>
                    <div class='page_msg'><div class='inner'><span class='msg_icon_wrp'><i class='icon80_smile'></i></span><div class='msg_content'><h4>我们目前只能在微信里面打开哦!</h4></div></div></div>
                    </body>
                </html>");
            }
        }
