		...
		<div class="panel-body">
			<div class="clearfix">
				...
				<div class="col-sm-5 text-right">
					<img <?php  if(file_exists(IA_ROOT . '/attachment/qrcode_'.$account['acid'].'.jpg')) { ?> src="<?php  echo $_W['attachurl_local'];?>qrcode_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>"<?php  } else { ?>src="resource/images/gw-qr.jpg"<?php  } ?> class="img-responsive img-thumbnail" width="150" />
					<img <?php  if(file_exists(IA_ROOT . '/attachment/headimg_'.$account['acid'].'.jpg')) { ?> src="<?php  echo $_W['attachurl_local'];?>headimg_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>"<?php  } else { ?>src="resource/images/gw-wx.gif"<?php  } ?> class="img-responsive img-thumbnail" width="150" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="panel-body" id="scroll">
		<div class="account-stat">
			<div class="account-stat-btn">
				<div>今日新关注人数<span><?php  echo $today_add_num;?></span></div>
				<div>今日取消关注人数<span><?php  echo $today_cancel_num;?></span></div>
				<div>今日净增关注人数<span><?php  echo $today_jing_num;?></span></div>
