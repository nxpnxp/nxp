    ...
    require(['bootstrap', 'angular', 'util', 'underscore'], function($, angular, u, _){
        $(function(){
            ...
            angular.module('app', []).controller('formPanel', function($scope, $http) {
                $scope.type = "<?php  echo $activity['type'];?>";
                ...
                define.amd = false;
                require(['<?php  echo $modulePublic;?>bootstrap3-typeahead.min.js'], function(){
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="title" value="<?php  echo $activity['title'];?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <p class="form-control-static">
                            <?php  if($activity['type'] == 'direct') { ?>直接送<?php  } ?>
                            <?php  if($activity['type'] == 'shared') { ?>助力讨礼品<?php  } ?>
                            <?php  if($activity['type'] == 'game') { ?>礼品游戏<?php  } ?>
                        </p>
                        <input name="type" type="hidden" value="<?php  echo $activity['type'];?>" />
                    </div>
                </div>
                <?php  } ?>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <textarea style="height:150px;" class="richtext-clone" name="rules"><?php  echo $activity['rules'];?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="guide" class="form-control" value="<?php  echo $activity['guide'];?>">
        ...
        <div class="panel panel-default" ng-show="type == 'game'">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="game[label]" value="<?php  echo $game['label'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="game[price]" value="<?php  echo $game['price'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="game[pool]" value="<?php  echo $game['pool'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="game[threshold]" value="<?php  echo $game['threshold'];?>" class="form-control">
        ...
        <div class="panel panel-default" ng-show="type == 'shared'">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[helps]" value="<?php  echo $shared['helps'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[progress]" class="form-control" value="<?php  echo $shared['progress'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[got]" class="form-control" value="<?php  echo $shared['got'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[request]" class="form-control" value="<?php  echo $shared['request'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[label]" class="form-control" value="<?php  echo $shared['label'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="shared[limit]" class="form-control" value="<?php  echo $shared['limit'];?>">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="limit[range]" class="form-control" value="<?php  echo $activity['limit']['range'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="limit[gender]" class="form-control" value="<?php  echo $activity['limit']['gender'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="limit[amount]" class="form-control" value="<?php  echo $activity['limit']['amount'];?>">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="share[title]" class="form-control" value="<?php  echo $activity['share']['title'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">分享文案</label>
                    <div class="col-sm-9 col-xs-12">
                        <textarea name="share[content]" class="form-control" rows="5"><?php  echo $activity['share']['content'];?></textarea>
                    </div>
                </div>
            </div>
        </div>
