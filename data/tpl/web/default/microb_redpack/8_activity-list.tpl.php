        ...
        <div class="table-responsive panel-body" style="overflow:visible;">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <p class="form-control-static form-control-static-list" style="line-height:1.8em;">
                            <span class="label label-info">总数量: <?php  echo $row['count']['total'];?></span> <br>
                            <span class="label label-info">已发放: <?php  echo $row['count']['already'];?></span> <br>
                            <span class="label label-info">还剩余: <?php  echo $row['count']['surplus'];?></span> <br>
                        </p>
                    </td>
