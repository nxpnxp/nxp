		...
		<div class="panel panel-default">
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						<th style="width:300px;">店员姓名</th>
						<th style="width:300px;">微信昵称</th>
					...
					<tr>
						...
						<td><a href="<?php  echo url('activity/offline/edit',array('id' => $item['id'],'do' =>'edit'));?>" title="编辑">编辑</a>&nbsp;-&nbsp;
				<a href="<?php  echo url('activity/offline/del', array('id' => $item['id'], 'do' => 'del'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除">删除</a>&nbsp;-&nbsp;</td>
					</tr>
					<?php  } } ?>
					</tbody>
				</table>
