        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <?php  if(!empty($item) && ($item['id']==1 || $item['id']==2 || $item['id']==5) ) { ?>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">分销设置</label>
                    <div class="col-sm-9 col-xs-12">
                        <div class='input-group'>
                            <span class='input-group-addon'>一级</span>
                            <input type="text" name="commission1" class="form-control" value="<?php  echo $cat_com['commission1'];?>" />
                            <span class='input-group-addon'>二级</span>
                            <input type="text" name="commission2" class="form-control" value="<?php  echo $cat_com['commission2'];?>" />
                            <span class='input-group-addon'>三级</span>
                            <input type="text" name="commission3" class="form-control" value="<?php  echo $cat_com['commission3'];?>" />
                            <span class='input-group-addon'>四级</span>
                            <input type="text" name="commission4" class="form-control" value="<?php  echo $cat_com['commission4'];?>" />
                            <span class='input-group-addon'>五级</span>
                            <input type="text" name="commission5" class="form-control" value="<?php  echo $cat_com['commission5'];?>" />
                            <span class='input-group-addon'>六级</span>
                            <input type="text" name="commission6" class="form-control" value="<?php  echo $cat_com['commission6'];?>" />
                        </div>
                        <?php  if($item['id']==5) { ?>
                        <div class='input-group' style="margin-top: 10px;">
                            <span class='input-group-addon'>六级分销最大值</span>
                        	<input type="text" name="f2c_max" class="form-control" value="<?php  echo $cat_com['f2c_max'];?>" />
                        </div>
                        <?php  } ?>
