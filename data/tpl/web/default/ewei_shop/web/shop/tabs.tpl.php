<?php defined('IN_IA') or exit('Access Denied');?><ul class="nav nav-tabs">
    ...
    <li <?php  if($_GPC['p'] == 'supply') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/supply')?>">供应商审核</a></li>
     <li <?php  if($_GPC['p'] == 'supplygoods') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/supplygoods')?>">供应商品审核</a></li>
</ul>
