...
<div class="panel panel-default">
        ...
        <table class="table table-hover">
            ...
            <tbody id='tbody-items'>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(cv('virtual.category.edit')) { ?>
                    ...
                    <td>
                          <?php if(cv('virtual.category.delete')) { ?><a href="<?php  echo $this->createPluginWebUrl('virtual/category', array('op' => 'delete', 'id' => $row['id']))?>"class="btn btn-default btn-sm" onclick="return confirm('确认删除此分类?')" title="删除"><i class="fa fa-times"></i></a><?php  } ?>
                    </td>
                    </td>
                </tr>
                <?php  } } ?> 
    ...
    <div class='panel-footer'>
            <?php if(cv('virtual.category.add')) { ?>
            <input name="button" type="button" class="btn btn-default" value="添加分类" onclick='addCategory()'>
           <?php  } ?>
           <?php if(cv('virtual.category.edit|virtual.category.add')) { ?>
