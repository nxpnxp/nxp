...
<td><?php  if(empty($row['levelname'])) { ?> <?php echo empty($this->set['levelname'])?'普通等级':$this->set['levelname']?><?php  } else { ?><?php  echo $row['levelname'];?><?php  } ?></td>
                    ...
                    <td>
                        ...
                        <br/>一级：<?php  echo $row['level1'];?> 人
                        <br/> 二级：<?php  echo $row['level2'];?> 人
                        <br/>三级：<?php  echo $row['level3'];?> 人
                        <br/>四级：<?php  echo $row['level4'];?> 人
                        <br/>五级：<?php  echo $row['level5'];?> 人
                        <br/>六级：<?php  echo $row['level6'];?> 人
                    </td>
                    <td>
                        <?php  if($row['status']==0) { ?>
