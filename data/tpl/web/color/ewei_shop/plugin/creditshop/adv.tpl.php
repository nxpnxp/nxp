            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('creditshop.adv.view|creditshop.adv.edit')) { ?><a href="<?php  echo $this->createPluginWebUrl('creditshop/adv', array('op' => 'post', 'id' => $row['id']))?>" class="btn btn-default btn-sm" 
                                                               title="<?php if(cv('creditshop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class="fa fa-edit"></i></a><?php  } ?>
                        <?php if(cv('creditshop.adv.delete')) { ?><a href="<?php  echo $this->createPluginWebUrl('creditshop/adv', array('op' => 'delete', 'id' => $row['id']))?>"class="btn btn-default btn-sm" onclick="return confirm('确认删除此幻灯片?')" title="删除"><i class="fa fa-times"></i></a><?php  } ?>
                    </td>
                </tr>
                <?php  } } ?> 
                <tr>
...
<div class="main">
    <form <?php if( ce('creditshop.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form" enctype="multipart/form-data" onsubmit='return formcheck()'>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                           <?php if( ce('creditshop.adv' ,$item) ) { ?>
                            ...
                            <input type="hidden" name="token" value="<?php  echo $_W['token'];?>" />
                        <?php  } ?>
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('creditshop.adv.add|creditshop.adv.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
                    </div>
            </div>
