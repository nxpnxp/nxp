<?php defined('IN_IA') or exit('Access Denied');?><ul class="nav nav-tabs">
    ...
    <?php  } ?>
    <?php if(cv('finance.recharge.view')) { ?><li <?php  if($_GPC['p'] == 'log' && $_GPC['type']==0) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('finance/log',array('type'=>0))?>">充值记录</a></li><?php  } ?>
