            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('shop.notice.view|shop.notice.edit')) { ?><a href="<?php  echo $this->createWebUrl('shop/notice', array('op' => 'post', 'id' => $row['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="<?php if(cv('shop.notice.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class="fa fa-edit"></i></a><?php  } ?>
