...
.module .item{border-bottom:1px #DDD dotted;margin-bottom:8px; padding-bottom:8px;}
.module .media .pull-right{margin-bottom:0;width:auto;overflow:hidden;}
...
.module .media-body .edit-info{margin-left:10px; color:#5c90d2; display:none;}
.module .media-body span{margin-top:6px; display:inline-block;}
.module .media-object{display:inline-block; float:left; margin-right:10px; width:40px; height:40px; overflow:hidden;border-radius: 50%;}
.module .media-heading{font-weight:normal; font-size:14px;}
