...
<a href="<?php  echo $this->createPluginMobileUrl('commission')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-users" style="color:#f90;"></i>分销中心<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
<a href="<?php  echo $this->createMobileUrl('member/supply')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-truck" style="color:#328233;"></i>申请成为供应商<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
...
<div class="cart"  style="margin-top:10px;"  >
    <a href="<?php  echo $this->createMobileUrl('shop/cart')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-shopping-cart" style="color:#f90;"></i>我的购物车<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    <a href="<?php  echo $this->createMobileUrl('shop/favorite')?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-heart" style="color:#f03;"></i>我的收藏<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
    ...
    <a href="javascript:;" id="btnwithdraw"><div class="list1" style="border-bottom: 0px;margin-top:10px;"><i class="fa fa-money" style="color:#0096ff;"></i>余额提现<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>    
    <?php  } ?>
    <a href="<?php  echo $this->createMobileUrl('member/log')?>"><div class="list1" style="<?php  if(isset($set['trade']) && $set['trade']['withdraw']==1) { ?>margin:0px;<?php  } ?>"><i class="fa fa-file-text" style="color:#009;"></i>
...
<a href="<?php  echo $this->createMobileUrl('shop/address')?>"><div class="list1"  style="margin-top:10px;"><i class="fa fa-street-view" style="color:#99C"></i>收货地址管理<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>
